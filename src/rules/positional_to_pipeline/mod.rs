...
impl DetectFix for TurnPositionalIntoStreamInput {
    ...
    fn fix(&self, context: &LintContext, fix_data: &Self::FixInput<'_>) -> Option<Fix> {
        ...
        let mut var_spans = block.var_usages(fix_data.param_var_id, context, |_, _, _| true);
            ...
            && after_first_end + 3 <= def_span_end
        {
            ...
            let after_text = context.span_text(after_span);
        ...
        let def_text = context.span_text(fix_data.def_span);
