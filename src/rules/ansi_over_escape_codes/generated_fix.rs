...
fn fix_red_escape() {
    ...
    RULE.assert_replacement_contains(source, "ansi red");
}

#[test]
fn fix_green_escape() {
    let source = r#"print "\e[32mSuccess\e[0m""#;
    RULE.assert_replacement_contains(source, "ansi green");
}

#[test]
fn fix_reset_escape() {
    let source = r#"print "Text\e[0m""#;
    RULE.assert_replacement_contains(source, "ansi reset");
}

#[test]
fn fix_bold_escape() {
    let source = r#"print "\e[1mBold\e[0m""#;
    RULE.assert_replacement_contains(source, "ansi bold");
}

#[test]
fn fix_uses_interpolation() {
    let source = r#"print "\e[33mWarning\e[0m""#;
    RULE.assert_replacement_contains(source, "$(ansi yellow)");
}
...
fn fix_cyan_color() {
    ...
    RULE.assert_replacement_contains(source, "ansi cyan");
}

#[test]
fn fix_underline_style() {
    let source = r#"print "\e[4mUnderline\e[0m""#;
    RULE.assert_replacement_contains(source, "ansi underline");
}

#[test]
fn fix_magenta_color() {
    let source = r#"print "\e[35mPurple\e[0m""#;
    RULE.assert_replacement_contains(source, "ansi magenta");
}
