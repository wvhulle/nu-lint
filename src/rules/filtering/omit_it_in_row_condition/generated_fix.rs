...
fn fix_simple_field_comparison() {
    ...
    RULE.assert_replacement_contains(source, r#"type"#);
}
...
fn fix_size_comparison() {
    ...
    RULE.assert_count(source, 1);
    RULE.assert_replacement_is(source, "size");
}
...
fn fix_name_comparison() {
    ...
    RULE.assert_count(source, 1);
    RULE.assert_replacement_is(source, "name");
}
...
fn fix_field_with_underscore() {
    ...
    RULE.assert_count(source, 1);
    RULE.assert_replacement_is(source, "first_name");
}
...
fn fix_numeric_comparison() {
    ...
    RULE.assert_count(source, 1);
    RULE.assert_replacement_is(source, "x");
}
...
fn fix_boolean_field() {
    ...
    RULE.assert_count(source, 1);
    RULE.assert_replacement_is(source, "active");
}
