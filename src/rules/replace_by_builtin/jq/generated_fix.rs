...
fn fix_jq_length() {
    ...
    rule().assert_fix_contains(source, "open $file | from json | length");
}
...
fn fix_jq_keys() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "columns");
    rule().assert_fix_contains(source, "from json");
}
...
fn fix_to_json_then_jq_add() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "math sum");
}
...
fn fix_to_json_then_jq_length() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "length");
}
...
fn fix_to_json_then_jq_flatten() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "flatten");
}
...
fn fix_jq_array_index() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "get 0");
    rule().assert_fix_contains(source, "from json");
}
...
fn fix_jq_negative_index() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "last");
}
...
fn fix_jq_field_access() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "get name");
    rule().assert_fix_contains(source, "from json");
}
...
fn fix_jq_nested_field_access() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "get user.email");
}
...
fn fix_jq_array_iteration() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "each");
}
...
fn fix_jq_field_array_iteration() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "get users | each");
}
...
fn fix_jq_group_by() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "group-by category");
}
...
fn fix_jq_sort_by() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "sort-by timestamp");
}
...
fn fix_jq_min() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "math min");
}
...
fn fix_jq_max() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "math max");
}
...
fn fix_jq_type() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "describe");
}
...
fn fix_jq_reverse() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "reverse");
}
...
fn fix_preserves_file_argument() {
    ...
    rule().assert_violation_count_exact(source, 1);
    rule().assert_fix_contains(source, "open $file");
    rule().assert_fix_contains(source, "get name");
}
