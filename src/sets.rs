...
pub const DEFAULT_RULE_MAP: RuleMap = RuleMap {
    ...
    rules: &[
        ...
        ("prefer_builtin_date", LintLevel::Warn),
        ("prefer_builtin_hostname", LintLevel::Warn),
        ("prefer_builtin_man", LintLevel::Warn),
        ("prefer_builtin_which", LintLevel::Warn),
        ("prefer_builtin_read", LintLevel::Warn),
        ("prefer_builtin_wc", LintLevel::Warn),
        ("prefer_builtin_awk", LintLevel::Warn),
        ("prefer_builtin_cut", LintLevel::Warn),
